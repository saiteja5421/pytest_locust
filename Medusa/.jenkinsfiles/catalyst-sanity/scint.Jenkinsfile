pipeline {
    ...
    parameters {
        ...
        string(defaultValue: 'refs/tags/s1-scint-may2024-v1',
                description: 'Default value is tags/s1-scint-may2024-v1, type your tag name if you want to run build using a specific tag',
                name: 'TAG',
                trim: true)
