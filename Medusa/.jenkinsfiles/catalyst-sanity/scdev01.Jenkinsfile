pipeline {
    ...
    /* same time as service 2 sanity suite pipeline (scdev01_sanity s1_s2) - it should run parallel */
    triggers {
        cron 'H 12 * * *'
    }
    ...
    environment {
        CONTAINER_NAME = "atlas-sanity-scdev01-${env.BUILD_NUMBER}"
