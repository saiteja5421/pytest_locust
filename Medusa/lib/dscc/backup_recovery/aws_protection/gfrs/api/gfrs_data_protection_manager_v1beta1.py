...
from lib.dscc.backup_recovery.aws_protection.gfrs.payload.file_system_info_v1beta1 import PostRestoreCSPFileSystemInfo

logger = logging.getLogger()


class GFRSDataProtectionManagerV1Beta1:
