...
# DSCC Model classes
from lib.dscc.backup_recovery.aws_protection.ec2.models.csp_machine_instance.csp_instance_v1beta1 import (
    CSPMachineInstance,
    CSPMachineInstanceList,
)
from lib.dscc.backup_recovery.aws_protection.ec2.models.csp_resource_group.csp_resource_group_v1beta1 import (
    CSPResourceGroup,
    CSPResourceGroupList,
)
from lib.dscc.backup_recovery.aws_protection.ec2.models.csp_subnet.csp_subnet_v1beta1 import (
    CSPSubnet,
    CSPSubnetList,
)
from lib.dscc.backup_recovery.aws_protection.ec2.models.csp_subscription.csp_subscription_v1beta1 import (
    CSPSubscription,
    CSPSubscriptionList,
)
from lib.dscc.backup_recovery.aws_protection.ec2.models.csp_vpc.csp_vpc_v1beta1 import (
    CSPVPC,
    CSPVPCList,
)
from lib.dscc.backup_recovery.aws_protection.ebs.models.csp_volume_v1beta1 import (
    CSPVolume,
    CSPVolumeList,
)
from lib.dscc.backup_recovery.aws_protection.protection_groups.models.protection_group_v1beta1 import (
    ProtectionGroup,
    ProtectionGroupList,
)
from lib.dscc.backup_recovery.aws_protection.protection_groups.payload.csp_protection_group_payload_v1beta1 import (
...
class InventoryManager:
    ...
    def get_csp_machine_instances(
        ...
        if expected_status_code == requests.codes.ok:
            ...
            ), f"Failed to retrieve CSP Machines {response.status_code}, {response.text}"
    ...
    def get_protection_group_by_id(
        ...
        ), f"Failed to fetch PG: {protection_group_id}, {response.text}"
    ...
    def delete_protection_group(
        ...
        ), f"PG deletion failed with status code: {response.status_code}, {response.content}"
        if response.status_code == requests.codes.accepted:
            return get_task_id_from_header(response)
        else:
            return GLCPErrorResponse(**response.json())
