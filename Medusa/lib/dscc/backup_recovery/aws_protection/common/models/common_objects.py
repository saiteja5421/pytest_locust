...
# @dataclass_json(letter_case=LetterCase.CAMEL)
# A temporary naming change: https://nimblejira.nimblestorage.com/browse/DCS-14466
# only used by CSPRDSInstanceBackup
@dataclass
...
class AttachmentInfo:
    attachedTo: ObjectNameResourceTypeId
    device: str
    lun: int = None
...
class AssetInfo:
    type: str
    cspType: Optional[str] = field(default="AWS")
