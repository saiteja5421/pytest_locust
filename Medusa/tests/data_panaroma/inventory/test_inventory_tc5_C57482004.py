"""
Test Case ID C57482004
Test Description - TC5:- Verify Customer able to update cost/location information of arrays
"""
...
1) data_location - Case1: Updating only location details of a system
2) data_cost - Case2: Updating only cost details of an array
3) data_costlocation - Case3: Updating both location details of a system and cost details of arrays belonging to that system
--------------------------------------------------------------------------------------------------------------------------------
"""

"""
Case1: Updating only location details of the system
...
"""
Case2: Updating only cost details of an array
...
"""
Case3: Updating both location details of a system and cost details of arrays belonging to that system.
...
def test_inventory_tc5_C57482004(context: context):
    logger.info("Start of test case")
    logger.info("PQA Testing -> Inventory -> TC5_C57482004")
    ...
    """
	------------------------------------------------------------------------------------------------------------------------------
	Case1: Updating location details of a system
	a) create a new location and assign it to the system
	b) from the existing location assign it to the system
	------------------------------------------------------------------------------------------------------------------------------
	"""
    ...
    # check whether the location details of those system are same as the ones going to be updated
    for sys_id in system_ids:
        system_location = Inventory_func.get_actual_system_location(sys_id)
        expected_sys_location = get_expected_system_location(datainput=data_location, system_id=sys_id)
        for var in system_location:
            assert (
                system_location[var] == expected_sys_location[var]
            ), f"System location details should be different from the current to proceed with test case."
    ...
    """
	------------------------------------------------------------------------------------------------------------------------------
	Case2: Updating cost details of an array
	------------------------------------------------------------------------------------------------------------------------------
	"""
    # Get all the array IDs associated with a system for which cost details has to be modified from input data and check whether the cost details of those arrays are same as the ones going to be updated
    ...
    for sys_id in system_ids:
        ...
        for array_id in array_ids:
            ...
            for costparam in array_cost:
                assert (
                    array_cost[costparam] == expected_array_cost[costparam]
                ), f"Array cost details should be different from the current to proceed with test case."
    ...
    """
	------------------------------------------------------------------------------------------------------------------------------
	Case3: Updating location details of a system and cost details of array belonging to that system.
	a) create a new location and assign it to the system
	b) from the existing location assign it to the system
    ...
    # If post call response is successful, trigger a collection and verify location and cost are updated successfully for the systems/arrays under test.
