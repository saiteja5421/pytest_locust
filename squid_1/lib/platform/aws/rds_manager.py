...
from common.enums.aws_rds_waiters import AWSRDSWaiters
from common.enums.db_engine import DBEngine
from common.enums.db_engine_versions import DBEngineVersion
from common.enums.db_instance_class import DBInstanceClass
from common.enums.rds_snapshot_type import RDSSnapshotType
    ...
    ***************************************************************************
    ...
    def create_db_instance(
        ...
        Args:
            ...
            master_username (str): Name for the master user.
            master_user_password (str): Password for the master user (can include all characters except: "/", '"', "@").
    ...
    def create_custom_db_instance_with_engine_version_and_parameter_subnet_group(
        ...
        Args:
            ...
            db_instance_class (DBInstanceClass, optional): Instance compute/memory capacity. Defaults to DBInstanceClass.DB_T3_MICRO.
            db_engine (DBEngine, optional): Type of DB Engine. Defaults to DBEngine.POSTGRES.
            db_parameter_group (str): The name of the DB parameter group to associate with this DB Instance, 1-255 letters/numbers/hyphens, can't end with hyphen or 2 consecutive hyphens master_username (str, optional): Name for the master user.
