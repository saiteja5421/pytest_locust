...
from utils.auth_token import set_token
...
class User(ApiHeader):
    def __init__(
        self, config, oauth2_server: str = "https://sso.common.cloud.hpe.com/as/token.oauth2", static_token=None
    ):
        api_client_cred = APIClientCredential(**config)
