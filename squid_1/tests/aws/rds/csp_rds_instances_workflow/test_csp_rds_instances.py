...
from tests.aws.rds.csp_rds_instances_workflow.task import CSPRDSInstanceTasks
...
def on_test_start(environment, **kwargs):
    try:
        ...
        global rp_test_id
        global rp_logger
        test_case_name = "CSP RDS Instances - lists and details"
