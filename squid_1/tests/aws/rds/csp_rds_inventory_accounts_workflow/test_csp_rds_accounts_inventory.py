...
from tests.aws.rds.csp_rds_inventory_accounts_workflow.task import CSPRDSAccountsInventory
...
def on_test_start(environment, **kwargs):
    try:
        ...
        global rp_test_id
        global rp_logger
        test_case_name = "CSP RDS Accounts - lists and details"
        rp_mgr, rp_test_id, rp_logger = rp_agent.create_test_in_report_portal(
            report_portal_dict,
            launch_suffix="RDS_ACCOUNTS_INVENTORY",
