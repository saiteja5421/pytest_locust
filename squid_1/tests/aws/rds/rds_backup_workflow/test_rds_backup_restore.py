...
from tests.aws.rds.rds_backup_workflow.task import RDSBackupTasks
...
def on_test_start(environment, **kwargs):
    try:
        ...
        global rp_test_id
        global rp_logger
        test_case_name = "RDS Local Backup Restore Workflow"
        rp_mgr, rp_test_id, rp_logger = rp_agent.create_test_in_report_portal(
            report_portal_dict,
            launch_suffix="RDS_BACKUP_RESTORE",
