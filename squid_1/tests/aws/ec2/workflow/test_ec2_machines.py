...
from tests.aws.ec2.workflow.task import Ec2Instances
...
# pre-requisite:Create_ec2.py shaould have been executed or few ec2 instances should be present in aws.
...
def on_test_start(environment, **kwargs):
    try:
        ...
        global rp_test_id
        global rp_logger
        test_case_name = "Test ec2 instances workflow"
