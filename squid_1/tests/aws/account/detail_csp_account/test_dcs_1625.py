...
from tests.aws.account.detail_csp_account.task import CspAccountDetailsTask
...
class LoadUser(HttpUser):
    ...
    def on_start(self):
        ...
        with self.client.get(
            config.Paths.AWS_ACCOUNTS, headers=self.headers.authentication_header, proxies=self.proxies
        ) as response:
